...
export const CANONICAL_KINSHIP_TERMS: Record<CanonicalTermKey, CanonicalKinshipTerm> = {
  ...
  OUTER_PATERNAL_GRANDUNCLE_WIFE_ELDER: { key: 'OUTER_PATERNAL_GRANDUNCLE_WIFE_ELDER', canonicalTitle: '外伯祖母', targetGender: 'female' },
  OUTER_PATERNAL_GRANDUNCLE_WIFE_YOUNGER: { key: 'OUTER_PATERNAL_GRANDUNCLE_WIFE_YOUNGER', canonicalTitle: '外叔祖母', targetGender: 'female' },
  ...
  OUTER_NEPHEW_WIFE: { key: 'OUTER_NEPHEW_WIFE', canonicalTitle: '外甥媳', targetGender: 'female' },
  OUTER_NEPHEW_HUSBAND: { key: 'OUTER_NEPHEW_HUSBAND', canonicalTitle: '外甥女婿', targetGender: 'male' },
  NEPHEW_GRANDSON_WIFE: { key: 'NEPHEW_GRANDSON_WIFE', canonicalTitle: '侄孙媳', targetGender: 'female' },
  NEPHEW_GRANDDAUGHTER_HUSBAND: { key: 'NEPHEW_GRANDDAUGHTER_HUSBAND', canonicalTitle: '侄孙女婿', targetGender: 'male' },
  NEPHEW_OUTER_GRANDSON_WIFE: { key: 'NEPHEW_OUTER_GRANDSON_WIFE', canonicalTitle: '侄外孙媳', targetGender: 'female' },
  NEPHEW_OUTER_GRANDDAUGHTER_HUSBAND: { key: 'NEPHEW_OUTER_GRANDDAUGHTER_HUSBAND', canonicalTitle: '侄外孙女婿', targetGender: 'male' },
  OUTER_NEPHEW_GRANDSON_WIFE: { key: 'OUTER_NEPHEW_GRANDSON_WIFE', canonicalTitle: '外甥孙媳', targetGender: 'female' },
  OUTER_NEPHEW_GRANDDAUGHTER_HUSBAND: { key: 'OUTER_NEPHEW_GRANDDAUGHTER_HUSBAND', canonicalTitle: '外甥孙女婿', targetGender: 'male' },
  OUTER_NEPHEW_OUTER_GRANDSON_WIFE: { key: 'OUTER_NEPHEW_OUTER_GRANDSON_WIFE', canonicalTitle: '外甥外孙媳', targetGender: 'female' },
  OUTER_NEPHEW_OUTER_GRANDDAUGHTER_HUSBAND: { key: 'OUTER_NEPHEW_OUTER_GRANDDAUGHTER_HUSBAND', canonicalTitle: '外甥外孙女婿', targetGender: 'male' },
  GRANDSON_WIFE: {
    key: 'GRANDSON_WIFE',
    canonicalTitle: '孙媳',
  ...
  OUTER_GREAT_GRANDSON_WIFE: { key: 'OUTER_GREAT_GRANDSON_WIFE', canonicalTitle: '外曾孙媳', targetGender: 'female' },
  OUTER_GREAT_GRANDDAUGHTER_HUSBAND: { key: 'OUTER_GREAT_GRANDDAUGHTER_HUSBAND', canonicalTitle: '外曾孙女婿', targetGender: 'male' },
  ...
  TANG_NEPHEW_GRANDSON_WIFE: { key: 'TANG_NEPHEW_GRANDSON_WIFE', canonicalTitle: '堂侄孙媳', targetGender: 'female' },
  TANG_NEPHEW_GRANDDAUGHTER_HUSBAND: { key: 'TANG_NEPHEW_GRANDDAUGHTER_HUSBAND', canonicalTitle: '堂侄孙女婿', targetGender: 'male' },
  BIAO_NEPHEW_GRANDSON_WIFE: { key: 'BIAO_NEPHEW_GRANDSON_WIFE', canonicalTitle: '表侄孙媳', targetGender: 'female' },
  BIAO_NEPHEW_GRANDDAUGHTER_HUSBAND: { key: 'BIAO_NEPHEW_GRANDDAUGHTER_HUSBAND', canonicalTitle: '表侄孙女婿', targetGender: 'male' },
