...
父母子女关系用于构建家庭关系脉络，配偶关系用于横向连接。添加兄弟姐妹时，系统会通过共同父母节点建立联系，因此若缺少父母节点，需先补充上一代成员。

在家庭树页面，你可以查看当前成员列表与关系描述。每增加或调整关系，家庭树会随之更新，便于家人共同核对。`
  },
  {
...
若暂不公开，家庭仍可仅在授权成员范围内使用，不影响日常维护家庭树与邀请亲人。`
  },
  {
    id: 'story-old-photo',
    category: 'story',
...
把照片与成员节点关联，并记下已知人物与地点，即使细节尚未齐全，也能为后来的亲人留下可查证的起点。`
  },
  {
    ...
    body: `祖父留下的手抄名谱只有薄薄几页，却记着从曾祖到孙辈的排行线索。部分名字与身份证用字不同，核对时需结合小名与亲属称呼交叉验证。
...
手抄材料的价值，在于它提示了关系线索，而不是要求一次性全部定论。`
  },
  {
    ...
    featured: true,
    body: `查证姓氏源流，通常需要结合地方志、旧资料牒与家族口述，不宜仅凭单一网络条目下结论。
...
不同分支堂号可能不同，并不必然表示没有亲缘关系。阅读旧资料时，宜将堂号、郡望与具体人物世系对照，而不是单独作为唯一依据。
...
这类内容适合放在家庭简介或文化注记中，供家人阅读，而不必与成员关系数据混为一谈。`
  },
  {
    ...
    category: 'article',
    title: '整理家庭树前需要准备什么',
    summary: '整理照片与口述信息，明确本次记录范围。',
    featured: true,
    body: `整理家庭树前先界定范围：是先记录身边亲人，还是逐步补充更早的长辈信息。范围不同，所需材料与工作量差异很大。

建议准备现有旧资料复印件、重要成员生平摘要、迁徙与堂号资料，并列出家中有谁熟悉旧资料。没有材料时，也可从健在长辈口述开始，逐条标注待核实项。
