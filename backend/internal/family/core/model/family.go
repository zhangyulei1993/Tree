...
type Family struct {
	...
	DissolutionCooldownUntil *time.Time `gorm:"column:dissolution_cooldown_until"`
	DissolutionCooldownDays  int        `gorm:"column:dissolution_cooldown_days;not null;default:0"`
	DissolutionHiddenAt      *time.Time `gorm:"column:dissolution_hidden_at"`
	DissolutionCompletedAt   *time.Time `gorm:"column:dissolution_completed_at"`
